...
export const enum_pages_hero_content_alignment = pgEnum('enum_pages_hero_content_alignment', [
  'left',
  'center',
  'right',
])
export const enum_pages_hero_content_vertical_alignment = pgEnum(
  'enum_pages_hero_content_vertical_alignment',
  ['top', 'center', 'bottom'],
)
export const enum_pages_hero_media_position = pgEnum('enum_pages_hero_media_position', [
  'top',
  'center',
  'bottom',
  'left',
...
export const enum__pages_v_version_hero_content_alignment = pgEnum(
  'enum__pages_v_version_hero_content_alignment',
  ['left', 'center', 'right'],
)
export const enum__pages_v_version_hero_content_vertical_alignment = pgEnum(
  'enum__pages_v_version_hero_content_vertical_alignment',
  ['top', 'center', 'bottom'],
)
export const enum__pages_v_version_hero_media_position = pgEnum(
  'enum__pages_v_version_hero_media_position',
...
export const enum_header_nav_items_sub_menu_links_link_type = pgEnum(
  'enum_header_nav_items_sub_menu_links_link_type',
  ['reference', 'custom'],
)
...
export const pages = pgTable(
  'pages',
  {
    ...
    hero_contentAlignment:
      enum_pages_hero_content_alignment('hero_content_alignment').default('center'),
    hero_contentVerticalAlignment: enum_pages_hero_content_vertical_alignment(
      'hero_content_vertical_alignment',
    ).default('center'),
    hero_richText: jsonb('hero_rich_text'),
    hero_media: integer('hero_media_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    hero_mediaPosition: enum_pages_hero_media_position('hero_media_position').default('center'),
...
export const pages_rels = pgTable(
  ...
  (columns) => [
    ...
    index('pages_rels_payload_folders_id_idx').on(columns['payload-foldersID']),
    ...
    foreignKey({
      ...
      name: 'pages_rels_payload_folders_fk',
    }).onDelete('cascade'),
    foreignKey({
...
export const _pages_v = pgTable(
  '_pages_v',
  {
    ...
    version_hero_contentAlignment: enum__pages_v_version_hero_content_alignment(
      'version_hero_content_alignment',
    ).default('center'),
    version_hero_contentVerticalAlignment: enum__pages_v_version_hero_content_vertical_alignment(
      'version_hero_content_vertical_alignment',
    ).default('center'),
    version_hero_richText: jsonb('version_hero_rich_text'),
    version_hero_media: integer('version_hero_media_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    version_hero_mediaPosition: enum__pages_v_version_hero_media_position(
      'version_hero_media_position',
    ).default('center'),
...
export const _pages_v_rels = pgTable(
  ...
  (columns) => [
    ...
    index('_pages_v_rels_payload_folders_id_idx').on(columns['payload-foldersID']),
    ...
    foreignKey({
      columns: [columns['payload-foldersID']],
      foreignColumns: [payload_folders.id],
      name: '_pages_v_rels_payload_folders_fk',
    }).onDelete('cascade'),
    foreignKey({
      columns: [columns['mediaID']],
      foreignColumns: [media.id],
...
export const header_nav_items_sub_menu_links = pgTable(
  'header_nav_items_sub_menu_links',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type: enum_header_nav_items_sub_menu_links_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    link_label: varchar('link_label'),
  },
  (columns) => [
    index('header_nav_items_sub_menu_links_order_idx').on(columns._order),
    index('header_nav_items_sub_menu_links_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [header_nav_items.id],
      name: 'header_nav_items_sub_menu_links_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const header_nav_items = pgTable(
  'header_nav_items',
  {
    ...
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    hasSubMenu: boolean('has_sub_menu'),
...
export const relations_pages_rels = relations(pages_rels, ({ one }) => ({
  ...
  'payload-foldersID': one(payload_folders, {
    fields: [pages_rels['payload-foldersID']],
...
export const relations__pages_v_rels = relations(_pages_v_rels, ({ one }) => ({
  ...
  'payload-foldersID': one(payload_folders, {
    fields: [_pages_v_rels['payload-foldersID']],
    references: [payload_folders.id],
    relationName: 'payload-folders',
  }),
  mediaID: one(media, {
...
export const relations_header_nav_items_sub_menu_links = relations(
  header_nav_items_sub_menu_links,
  ({ one }) => ({
    _parentID: one(header_nav_items, {
      fields: [header_nav_items_sub_menu_links._parentID],
      references: [header_nav_items.id],
      relationName: 'subMenuLinks',
    }),
  }),
)
export const relations_header_nav_items = relations(header_nav_items, ({ one, many }) => ({
  ...
  subMenuLinks: many(header_nav_items_sub_menu_links, {
    relationName: 'subMenuLinks',
  }),
}))
...
type DatabaseSchema = {
  ...
  enum_pages_hero_content_alignment: typeof enum_pages_hero_content_alignment
  enum_pages_hero_content_vertical_alignment: typeof enum_pages_hero_content_vertical_alignment
  enum_pages_hero_media_position: typeof enum_pages_hero_media_position
  ...
  enum__pages_v_version_hero_content_alignment: typeof enum__pages_v_version_hero_content_alignment
  enum__pages_v_version_hero_content_vertical_alignment: typeof enum__pages_v_version_hero_content_vertical_alignment
  enum__pages_v_version_hero_media_position: typeof enum__pages_v_version_hero_media_position
  ...
  enum_header_nav_items_sub_menu_links_link_type: typeof enum_header_nav_items_sub_menu_links_link_type
  ...
  header_nav_items_sub_menu_links: typeof header_nav_items_sub_menu_links
  ...
  relations_header_nav_items_sub_menu_links: typeof relations_header_nav_items_sub_menu_links
